...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = 'cg3dd.com 是一个针对于CG、设计、技术、建筑、艺术、软件等行业公益性资源分享网站，是专业的行业信息大全、资源分享平台';
$cfg_description = 'cg3dd.com|CG网站|设计网站|网站收藏|设计网站|建筑网站导航|艺术设计网站|网站导航|资源下载|教程下载';
$cfg_beian = 'Copyright &copy;2019 cg3dd all right reserved. 苏ICP备19031229号-1';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
$cfg_typedir_df = 'Y';
